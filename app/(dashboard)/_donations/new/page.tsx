        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter the donor's details for this donation
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Specify the donation amount and payment information
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInputChange("recurring", checked as boolean)
                  }
                />
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInputChange("sendReceipt", checked as boolean)
                  }
                ...
                <Label
                  htmlFor="sendReceipt"
                  className={
                    formData.anonymous || !formData.email ? "text-gray-400" : ""
                  }
                >
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInputChange("sendThankYou", checked as boolean)
                  }
                  disabled={formData.anonymous || !formData.email}
                />
                <Label
                  htmlFor="sendThankYou"
                  className={
                    formData.anonymous || !formData.email ? "text-gray-400" : ""
                  }
                >
              ...
              {(formData.anonymous || !formData.email) && (
                <p className="text-xs text-gray-500">
                  Email required for communication options
                </p>
              )}
            </CardContent>
          </Card>
