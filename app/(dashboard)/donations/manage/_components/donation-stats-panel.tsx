...
const statItems = (summary: DonationSummary) => [
  ...
  },
  {
    ...
    detail: money(summary.completedAmount),
    icon: CheckCircle2,
  },
  {
    label: "Pending",
  ...
  },
  {
    ...
    value: (summary.failed + summary.cancelled + summary.refunded).toLocaleString(),
    detail: `${summary.failed} failed · ${summary.cancelled} cancelled · ${summary.refunded} refunded`,
    icon: XCircle,
  },
];
